...
MERGE_CSS = """    .briefing-body .merged { font-family: Inter, Arial, Helvetica, sans-serif; }
    .briefing-body .merged h1 { font-size: 1.15rem; font-weight: 700; margin: 26px 0 6px; color: #e2e8f0; line-height: 1.15; }
    .briefing-body .merged p { margin: 0 0 10px; line-height: 1.4; color: #cbd5e1; }
    .briefing-body .merged ul { padding-left: 20px; margin: 0 0 12px; list-style: none; }
    .briefing-body .merged ul li { margin: 0 0 4px 18px; padding: 0; line-height: 1.4; color: #cbd5e1; font-size: 0.95rem; }
